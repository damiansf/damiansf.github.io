<template>
  <div>
    <vue-typed-js
      :typeSpeed="20"
      :showCursor="true"
      :strings="['cat welcome.txt && cat projects.txt']"
    >
    ...
    <vue-typed-js
      ...
      :showCursor="false"
      :startDelay="1500"
      :strings="['Hello, my name is Damian Sandhu-Franceschi. I am a Computer Science student at the University of Guelph, welcome to my portfolio!']"
    >
