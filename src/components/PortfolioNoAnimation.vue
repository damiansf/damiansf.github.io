<template>
  <div>
    ...
    <ul>
      <li><a href=https://github.com/damiansf/guelphCourser>Guelph Courser</a> Google chrome extension to improve UofGs course selection website</li>
